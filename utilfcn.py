...
## TODO change stepper motor to linear actuator accessed via gpio
...
def validate_json(data):
    ...
    if not 'ORIGIN' in data and not 'TARGET' in data:
        print('Unexpected Json format. Missing Origin and Target fields')
        return 0;
    else:
        if not data['ORIGIN'] in data and not data['TARGET'] in data:
            print('Target and Origin fields dont specify an element in the data')
            return 0;
        else:
            return 1;
